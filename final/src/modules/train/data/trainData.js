export const STATIONS = [
  ...
  { id: 'pingtung',    name: '屏東' },
  // 深澳線（瑞芳 → 八斗子）
  { id: 'ruifang',     name: '瑞芳',   transfer: true },
  { id: 'mudan',       name: '牡丹' },
  { id: 'haikeguan',   name: '海科館' },
  { id: 'badouzi',     name: '八斗子' },
  // 平溪線（瑞芳 → 菁桐，瑞芳 已列於深澳線）
  { id: 'sandiaoline', name: '三貂嶺' },
  { id: 'dahua',       name: '大華' },
  { id: 'shifen',      name: '十分' },
  { id: 'wanggu',      name: '望古' },
  { id: 'lingjiao',    name: '嶺腳' },
...
export const STATION_GROUPS = [
  {
    label: '縱貫線北',
    stations: [
      'keelung','sanken','badu','qidu','baifu','wudu',
      'xizhi','xike','nangang','songshan','taipei','wanhua',
      'banqiao','fuzhou','shulin','shanjia','yingge','taoyuan',
      'neili','zhongli','puxin','yangmei','fugang','hukou',
      'xinfeng','zhubei','hsinchu',
    ],
  },
  {
    label: '縱貫線南',
    stations: [
      'zhunan','miaoli','taichung','changhua','yuanlin',
      'douliu','chiayi','sinying','tainan','kaohsiung','pingtung',
    ],
  },
  {
    label: '深澳線',
    stations: ['ruifang','mudan','haikeguan','badouzi'],
  },
  {
    label: '平溪線',
    // 瑞芳已在深澳線群組中，不重複
    stations: ['sandiaoline','dahua','shifen','wanggu','lingjiao','pingxi','jingtong'],
  },
];
