...
export default function PropertyDetailPage() {
  ...
  const handleBookNow = (room) => {
    ...
    navigate('/hotel/booking', { state: { property, room, checkIn, checkOut, nights, guests: searchParams.guests || 1 } });
  };
  ...
  const handleChat = () => {
    if (!currentUser) { addToast('請先登入', 'error'); navigate('/login'); return; }
    navigate('/hotel/chat', { state: { hostId: property.hostId, propertyId: id } });
  };
